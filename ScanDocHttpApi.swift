...
internal protocol ScanDocHttpApi {
    func authenticate(_ callback: @escaping (Result<AuthenticateResponse, Error>) -> Void)
    ...
    func extraction(accessToken: String, _ extractionParams: ScanDocExtractionRequest, _ callback: @escaping (Result<ExtractionResponse, Error>) -> Void)
}
